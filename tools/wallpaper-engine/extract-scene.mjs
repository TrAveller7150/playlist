...
const input = fs.readFileSync('source/wallpaper-engine/2700262458/scene.pkg');
let cursor = 0;
...
const start = cursor;
const root = path.resolve('site/assets/scene');
...
console.log(`Extracted ${files.length} files from ${version} to site/assets/scene`);
